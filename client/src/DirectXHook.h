    ...
    namespace DirectX {
        ...
        void RenderMenu() {
            ...
            if (ImGui::Button("Disconnect")) {
                Network::NetworkClient::GetInstance().Disconnect();
            }

            if (Network::NetworkClient::GetInstance().IsConnected()) {
                ImGui::TextColored(ImVec4(0, 1, 0, 1), "Connected (ID: %u)",
                    Network::NetworkClient::GetInstance().GetPlayerId());
            } else {
